...
- ✅ Управление сертификатами (отдельный блок с возможностью указать наличие сертификата)
- ✅ Автоматический сброс отметок в 0:00 МСК
- ✅ Расчет времени до достижения цели (отображается в карточке фракции, автоматически обновляется при изменении активностей)
...
- ✅ Редактирование валюты и валюты с работы через диалоги
