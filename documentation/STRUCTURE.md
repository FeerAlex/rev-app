...
- `CurrencyInputDialog` - универсальный диалог для ввода/редактирования валюты (поддерживает пустые значения для валюты с работы, имеет иконку валюты `Icons.monetization_on` в поле ввода, расположен в `widgets/currency/`)
