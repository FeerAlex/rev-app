...
- Показывает название текущего уровня отношения
- Отображает опыт на текущем уровне в формате "текущий/требуемый" (например, "5000/43000")
- Progress bar с цветом, соответствующим уровню
...
- Отображает ReputationProgressBar
- Позволяет выбрать текущий уровень отношения через Dropdown
- Позволяет редактировать опыт на текущем уровне
- Позволяет выбрать целевой уровень отношения
- Отображает время до достижения целевого уровня
