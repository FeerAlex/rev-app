...
- Иконка сертификата (`CertificateIcon`) - справа от валюты, кликабельно
...
- `CertificateIcon` - иконка сертификата с возможностью переключения статуса покупки
