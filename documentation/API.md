...
- `searchQuestions(String query)` - выполняет поиск вопросов по запросу. Поиск выполняется одновременно по тексту вопроса и всем элементам массива ответов, без учета регистра. Возвращает список вопросов, содержащих запрос в тексте вопроса или в любом из ответов
...
**Возвращает:**
- `Future<List<Question>>` - список вопросов, содержащих запрос в тексте вопроса или в любом из ответов

**Описание:**
Выполняет поиск вопросов по запросу. Поиск выполняется одновременно по тексту вопроса и всем элементам массива ответов, без учета регистра. При пустом запросе возвращает все вопросы.
