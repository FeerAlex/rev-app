...
**Миграции:**
- Версия 10: Добавлены колонки `current_reputation_level`, `current_level_exp`, `target_reputation_level` для отслеживания репутации
- Версия 11: Исправление миграции - проверка наличия старых колонок (`current_exp`) и добавление новых колонок при необходимости
- Версия 12: Добавлена колонка `wants_certificate`, поле `target_reputation_level` сделано nullable

**Примечание:** 
- При обновлении с версии 9 на 10 автоматически добавляются колонки для репутации
- При обновлении с версии 10 на 11 проверяется наличие старых колонок и добавляются новые при необходимости
- При обновлении с версии 11 на 12 автоматически добавляется колонка `wants_certificate` и изменяется `target_reputation_level` на nullable
