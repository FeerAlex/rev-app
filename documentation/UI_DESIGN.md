...
┌─────────────────────────────────────┐
│ Текст вопроса                       │
│ Текст ответа (приглушенный)         │
└─────────────────────────────────────┘
```

**Элементы:**
- **Текст вопроса** - белый цвет, жирный шрифт, 16px
- **Текст ответа** - приглушенный серый цвет (60% прозрачности белого), обычный шрифт, 14px

**Особенности:**
- Темный фон карточки (`#2A2A2A`)
- Скругленные углы (12px)
- Отступы 16px
- Вертикальный отступ между вопросом и ответом (8px)
