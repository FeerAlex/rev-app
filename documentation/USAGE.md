...
1. При первом запуске приложения автоматически создается база данных с дефолтными настройками
2. Рекомендуется сразу перейти в раздел "Настройки" и настроить параметры

### Настройка приложения

Перед началом работы с фракциями необходимо настроить общие параметры:

1. Откройте вкладку **"Настройки"** в нижней панели навигации
2. Заполните следующие поля:
   - **Цена 1 итемки** - стоимость одной итемки в валюте фракции (целое число)
   - **Количество итемок для улучшения** - для каждого из трех украшений (целое число)
   - **Стоимость украшений** - цена покупки каждого украшения (целое число)
   - **Валюта за заказ** - сколько валюты вы получаете за выполнение заказа (целое число)
   - **Стоимость сертификата** - цена сертификата (целое число)
...
**Примечание:** Валюту и валюту с доски можно указать позже, нажав на соответствующие элементы в карточке фракции.
...
- Нет дохода в день (во фракции нет заказов и не указана доска)
...
2. **Валюта с доски** - нажмите на бейдж "Доска" или значение валюты в списке активностей
...
4. **Настройте параметры** - перед началом работы обязательно настройте все параметры в разделе "Настройки"
...
8. **Валюта с доски** - указывайте валюту с доски для более точного расчета времени до цели
