...
Функционал "Клуб знатоков" предназначен для поиска ответов на вопросы из ивента "Клуб знатоков" в игре Revelation Online.
...
Вопросы и ответы хранятся в файле `assets/questions/questions_club.json` в формате JSON:
...
**Примечание:** Поле `answers` - это массив строк. Вопрос может иметь один или несколько правильных ответов. Все ответы отображаются в карточке через запятую.
