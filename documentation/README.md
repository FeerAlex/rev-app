...
1. **[ARCHITECTURE.md](ARCHITECTURE.md)** - Описание архитектуры приложения
...
3. **[DATABASE.md](DATABASE.md)** - Схема базы данных
   - Описание таблиц
   - SQL запросы создания
   - Расположение БД

4. **[USAGE.md](USAGE.md)** - Руководство пользователя
   - Начало работы
   - Работа с фракциями
...
6. **[UI_DESIGN.md](UI_DESIGN.md)** - Дизайн пользовательского интерфейса
   - Цветовая схема
   - Компоненты UI
   - Типографика
   - Иконки и визуальные элементы

7. **[Task.md](Task.md)** - Исходное техническое задание
...
- ✅ Настройка параметров (цены, валюты, итемки)
